...
import { db, type Entry, type MealEntry, type SleepEntry, type BrainFogEntry } from '../db'
...
function useRecentEntries(): Entry[] {
  return useLiveQuery(async () => {
    ...
    return all
      .sort((a, b) => {
        const ta = a.type === 'sleep' ? a.wake_time : (a as MealEntry | BrainFogEntry).timestamp
        const tb = b.type === 'sleep' ? b.wake_time : (b as MealEntry | BrainFogEntry).timestamp
